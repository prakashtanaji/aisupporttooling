...
class CalculateFinalCostTests(unittest.TestCase):
    ...
    def test_calculate_final_cost_with_none_discount_treats_it_as_zero(self):
        self.assertEqual(calculate_final_cost(100, None), 100)
